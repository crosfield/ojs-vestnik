...
class ArticleHandler extends Handler {
	...
	function view($args, $request) {
		...
		if ($article->getLocalizedCopyrightHolder()) $templateMgr->assign(array(
		...
		$templateMgr->assign('subjects', $submissionSubjectDao->getSubjects($article->getId(), array(AppLocale::getLocale())));

		// Languages
		// $submissionLanguageDao = DAORegistry::getDAO('SubmissionLanguageDAO');
		// $templateMgr->assign('languages', $submissionLanguageDao->getSubjects($article->getId(), array(AppLocale::getLocale())));
