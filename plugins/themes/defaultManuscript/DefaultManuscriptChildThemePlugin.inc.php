...
class DefaultManuscriptChildThemePlugin extends ThemePlugin {
	...
	public function init() {
		...
		// Load Cookie Consent Law popups
		$this->addStyle(
			'cookieconsent',
			'/styles/cookieconsent.min.css',
			array('baseUrl' => '')
		);
		$this->addScript('cookieconsent', 'js/cookieconsent.min.js');

		if (AppLocale::getLocale() == 'en_US') {
			$this->addScript('cookieconsentru', 'js/cookieconsent_en.js');
		} else {
			$this->addScript('cookieconsenten', 'js/cookieconsent_ru.js');
		}

		// LightGallery
		$this->addScript('LightGallery', 'js/lightgallery/lightgallery-all.min.js');
		$this->addScript('mousewheel', 'js/lightgallery/jquery.mousewheel.min.js');
		$this->addScript('lightgallery_run', 'js/lightgallery/lightgallery_run.js');
