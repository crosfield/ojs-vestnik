...
abstract class Submission extends DataObject {
	...
	/**
	 * Return string of author names with initials, separated by the specified token
	 * @param $lastOnly boolean return list of lastnames only (default false)
	 * @param $nameSeparator string Separator for names (default comma+space)
	 * @param $userGroupSeparator string Separator for user groups (default semicolon+space)
	 * @return string
	 */
	function getAuthorStringInitials($lastOnly = false, $nameSeparator = ', ', $userGroupSeparator = '; ') {
		$authors = $this->getAuthors(true);
		...
		foreach($authors as $author) {
			...
			$str .= $lastOnly ? $author->getLastName() : $author->getFullNameInitials();
			$lastUserGroupId = $author->getUserGroupId();
		}
	...
	/**
	 * Return string of author names with initials (en_US locale), separated by the specified token
	 * @param $lastOnly boolean return list of lastnames only (default false)
	 * @param $nameSeparator string Separator for names (default comma+space)
	 * @param $userGroupSeparator string Separator for user groups (default semicolon+space)
	 * @return string
	 */
	function getAuthorStringInitials_en_US($lastOnly = false, $nameSeparator = ', ', $userGroupSeparator = '; ') {
		$authors = $this->getAuthors(true);
		...
		foreach($authors as $author) {
			...
			$str .= $lastOnly ? $author->getLastName() : $author->getFullNameInitials_en_US();
			$lastUserGroupId = $author->getUserGroupId();
		}
	...
	/**
	 * Get "localized" submission UDC (if applicable).
	 * @return string
	 */
	function getLocalizedUdc() {
		return $this->getLocalizedData('udc');
	}
	 ...
	 * @return string
	 */
	function getUdc($locale) {
		return $this->getData('udc', $locale);
	}
	 ...
	 * @param $locale
	 */
	function setUdc($udc, $locale) {
		$this->setData('udc', $udc, $locale);
	}
	...
	/**
	 * Get "localized" submission acknowledgement (if applicable).
	 * @return string
	 */
	function getLocalizedAcknowledgement() {
		return $this->getLocalizedData('acknowledgement');
	}
	 ...
	 * @return string
	 */
	function getAcknowledgement($locale) {
		return $this->getData('acknowledgement', $locale);
	}
	 ...
	 * @param $locale
	 */
	function setAcknowledgement($acknowledgement, $locale) {
		$this->setData('acknowledgement', $acknowledgement, $locale);
	}
