...
class PKPSubmissionMetadataFormImplementation {
	...
	function initData($submission) {
		if (isset($submission)) {
			$formData = array(
				...
				'udc' => $submission->getUdc(),
				'acknowledgement' => $submission->getAcknowledgement(null), // Localized
			);
	...
	function readInputData() {
		...
		$userVars = array('title', 'prefix', 'subtitle', 'abstract', 'coverage', 'type', 'source', 'rights', 'keywords', 'citations', 'acknowledgement', 'locale', 'udc');
	...
	function getLocaleFieldNames() {
		return array('title', 'prefix', 'subtitle', 'abstract', 'coverage', 'type', 'source', 'rights', 'keywords',  'citations', 'acknowledgement', 'udc');
	}
	...
	function execute($submission, $request) {
		...
		$submission->setUdc($this->_parentForm->getData('udc'),null); // Localized
		$submission->setAcknowledgement($this->_parentForm->getData('acknowledgement'), null); // Localized
