...
class SubmissionNativeXmlFilter extends NativeExportFilter {
	...
	function addMetadata($doc, $submissionNode, $submission) {
		...
		// $this->createLocalizedNodes($doc, $submissionNode, 'citations', $submission->getCitations(null));
		// $this->createLocalizedNodes($doc, $submissionNode, 'udc', $submission->getUdc(null));
