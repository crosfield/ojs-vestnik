...
{fbvFormArea id="userDetails"}
	{fbvFormSection title="user.name"}
		{fbvElement type="text" label="user.firstName" multilingual="true" required="true" id="firstName" value=$firstName maxlength="40" size=$fbvStyles.size.MEDIUM}
		{fbvElement type="text" label="user.middleName" multilingual="true" id="middleName" value=$middleName maxlength="40" size=$fbvStyles.size.MEDIUM}
		{fbvElement type="text" label="user.lastName" multilingual="true" required="true" id="lastName" value=$lastName maxlength="40" size=$fbvStyles.size.MEDIUM}
	{/fbvFormSection}
...
{capture assign="extraContent"}
	{fbvFormArea id="userFormExtendedLeft"}
		...
		{fbvFormSection for="affiliation"}
			{fbvElement type="text" label="user.affiliation" multilingual="true" name="affiliation" id="affiliation" value=$affiliation}
		{/fbvFormSection}
