...
{if $type=="pdf"}
	...
	{/if}
{else}
	<a class="{if $isSupplementary}obj_galley_link_supplementary{else}obj_galley_link{/if} {$type}{if $restricted} restricted{/if}" href="{url page=$page op="view" path=$parentId|to_array:$galley->getBestGalleyId()}">{$galley->getGalleyLabel()|escape}</a>
{/if}
