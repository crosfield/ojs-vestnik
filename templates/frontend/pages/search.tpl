...
<div class="page page_search">
	...
	<div class="search_results">
		{iterate from=results item=result}
			{include file="frontend/objects/article_search_summary.tpl" article=$result.publishedArticle journal=$result.journal issue=$result.issue showDatePublished=true hideGalleys=true}
		{/iterate}
	</div>
